...
add(id="lxx-1-1", work="lxx", author="lxx-translators", tradition="greek-jewish",
    ...
    english={"text": "In the beginning God made the heaven and the earth.", **APPROVED},
...
add(id="vulgate-1-1", work="vulgate", author="jerome", tradition="latin",
    ...
    english={"text": "In the beginning God created the heaven and the earth.", **APPROVED},
    cruxes=["beginning-of-what", "heaven-earth-order", "ex-nihilo-or-matter", "elohim-and-trinity"], senses=["translation"],
    answers=["principio-temporis"],
...
add(id="targ-onk-1-1", work="targ-onk", author="onkelos", tradition="rabbinic",
    ...
    english={"text": "In the beginning the LORD created the heavens and the earth.", **APPROVED},
    cruxes=["beginning-of-what", "heaven-earth-order", "ex-nihilo-or-matter", "elohim-and-trinity"], senses=["translation"],
    answers=["principio-temporis"],
...
add(id="aug-conf-11-9", work="aug-conf", author="augustine", tradition="latin",
    ...
    english={"text": "In this Beginning, God, you made heaven and earth: in your Word, in your Son, in your Strength, in your Wisdom, in your Truth, speaking in a wondrous way and in a wondrous way making. Who shall grasp it? who shall tell it?", **APPROVED},
...
add(id="aug-civ-11-32", work="aug-civ", author="augustine", tradition="latin",
    ...
    english={"text": "For when it is said thus, 'In the beginning God made heaven and earth', so that the Father is understood to have made in the Son — as the Psalm bears witness, where it reads, 'How magnified are your works, O Lord! you have made all things in wisdom' (Ps 104:24 [Vg 103:24]) — most fittingly a little after the Holy Spirit also is mentioned. For when it had been said what kind of earth God first made, or what mass and matter he had called by the name of heaven and earth for the construction of the world to come, by subjoining and adding, 'But the earth was invisible and unordered, and darkness was over the abyss', at once, that the mention of the Trinity might be completed, 'And the Spirit,' he says, 'of God was borne above the water' (Gen 1:1–3).", **APPROVED},
...
add(id="alcuin-int-26", work="alcuin-int", author="alcuin", tradition="latin",
    ...
    english={"text": "Question 26. What is: 'In the beginning God created heaven and earth'? — Answer. In the Son God completed [ms.: made] heaven and earth.", **APPROVED},
    cruxes=["beginning-of-what"], senses=["allegorical"],
    answers=["principio-in-filio"],
