...
add(id="lxx-1-3", work="lxx", author="lxx-translators", tradition="greek-jewish",
    ...
    english={"text": "And God said, Let light be made. And light was made.", **DRAFT},
...
add(id="vulgate-1-3", work="vulgate", author="jerome", tradition="latin",
    ...
    english={"text": "And God said: Let there be light. And light was made.", **DRAFT},
    cruxes=["first-light"], senses=["translation"],
    answers=["fiat-is-instantaneous"],
...
add(id="br-3-6", work="br", author="bereshit-rabbah", tradition="rabbinic",
    ...
    original={"lang": "he", "text": sef("br-3", "he", 5, he_file="br-3-he.json")[0], "source": "Bereshit Rabbah 3:6 (Vilna numbering)", **_BR_SRC},
    english={"text": sef("br-3", "en", 5)[0], **_BR_EN},
    tradents=["r-nechemya", "r-zeeira", "r-yehuda-b-simon"],
...
add(id="aug-gnl-1-3", work="aug-gnl", author="augustine", tradition="latin",
    ...
    english={"text": "And what is that light itself which was made? Is it something spiritual, or something bodily? For if spiritual, it can itself be the first creature, already made perfect by this saying, which was first called heaven when it was said, 'In the beginning God made heaven and earth' — so that what God said, 'Let there be light, and light was made', may be understood as its conversion and illumination, the Creator calling it back to himself.", **DRAFT},
    cruxes=["first-light"], senses=["literal"],
...
add(id="alcuin-int-33", work="alcuin-int", author="alcuin", tradition="latin",
    ...
    english={"text": "Question 33. Why is light read to have been created on the first day? — Answer. It befits the works of God that on the first day a temporal light should first be made from the eternal light, so that there might be something from which the rest that he would create could appear.", **DRAFT},
    cruxes=["first-light"], senses=["literal"],
    answers=["lux-corporalis"],
...
add(id="remigius-gen-1-3", work="remigius-gen", author="remigius", tradition="latin",
    ...
    english={"text": "'Let there be light.' Light (lux) is so called from cleansing (luendo), that is, from purging away the darkness. But that light was not of the kind that now is, with the sun set above; rather it was such as it is wont to be before the rising of the sun, or after its setting.", **DRAFT},
    cruxes=["first-light"], senses=["literal"],
...
add(id="bruno-gen-1-3", work="bruno-gen", author="bruno-of-segni", tradition="latin",
    ...
    english={"text": "But what is that light, which is said to be prior to the sun, the moon and the stars? Hear what follows: 'He called the light Day, and the darkness Night.' Light, therefore, is put for day.", **DRAFT},
    cruxes=["first-light"], senses=["literal"],
    answers=["lux-is-day"],
...
add(id="hugh-adnot-1-3", work="hugh-adnot", author="hugh-of-st-victor", tradition="latin",
    ...
    english={"text": "But fire, once distinguished, furnished light of some kind to the lower world, and had a circular motion: it was carried round like a kind of luminous cloud, as the sun is now.", **DRAFT},
    cruxes=["first-light"], senses=["literal"],
    answers=["lux-corporalis", "lux-twilight"],
