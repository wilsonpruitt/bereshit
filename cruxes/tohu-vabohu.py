...
add(id="aug-conf-12-4", work="aug-conf", author="augustine", tradition="latin",
    ...
    english={"text": "What then was it to be called, so as to be conveyed even to those slower of understanding, if not by some familiar word? And what can be found in all the parts of the world nearer to complete formlessness than earth and the deep? For they are less comely, in their lowest degree, than all the other higher things, translucent and full of light. Why then should I not accept that the formlessness of matter — which you had made without form, that from it you might make a world of form — was so conveniently intimated to men that it should be called 'earth invisible and unordered'? [Chapter V. Why formless matter seems to be so called.] So that when thought searches in it for what sense may reach, and says to itself, It is not an intelligible form like life, like justice, since it is the matter of bodies; nor is it perceptible by sense, since what may be seen and what may be felt is not in the invisible and unordered — while human thought says this to itself, let it try either to know it by not knowing, or to be ignorant of it by knowing.", **DRAFT},
    cruxes=["tohu-vabohu"], senses=["literal"],
...
add(id="isidore-quaest-1-2", work="isidore-quaest", author="isidore", tradition="latin",
    ...
    english={"text": "'But the earth was empty and void.' The earth, that is, of our flesh was empty and void, before it received the form of doctrine. 'And darkness was upon the face of the deep', because the blindness of our sins and the deep obscurity of ignorance covered our hearts.", **DRAFT},
    cruxes=["tohu-vabohu"], senses=["allegorical"],
...
add(id="alcuin-int-30", work="alcuin-int", author="alcuin", tradition="latin",
    ...
    english={"text": "Question 30. What is: 'But the earth was invisible and unordered' (ibid., from the Septuagint version)? — Answer. Invisible because of darkness; unordered because of shapelessness.", **DRAFT},
...
add(id="hugh-adnot-1-2-tohu", work="hugh-adnot", author="hugh-of-st-victor", tradition="latin",
    ...
    english={"text": "'But the earth was empty and void.' Empty of seeds; void of shoots; or empty on account of its hollowness; void, because in so great a hollowness of the earth there was nothing but air and mist.", **DRAFT},
    cruxes=["tohu-vabohu"], senses=["literal"],
    answers=["pair-is-unfurnished"],
...
add(id="comestor-hs-1-2-tohu", work="comestor-hs", author="comestor", tradition="latin",
    ...
    english={"text": "'But the earth was empty and void' (Gen 1) — that is, the world-machine was still useless, and unfruitful, and void of its adornment. 'And darkness was upon the face of the deep.' The same machine which he had called earth he calls the deep, on account of its confusion and darkness. Whence the Greek called it chaos.", **DRAFT},
    cruxes=["tohu-vabohu"], senses=["literal"],
