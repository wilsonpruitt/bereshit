...
FINDING = ("The Latin bench is not reading one verse but two. Augustine, Ambrose, Basil-in-Latin and Alcuin expound "
           ...
           "verse is left without a note by the man who wrote it. The Latin bench's second text has a head it did not know about, and the other bench's hardest word has an etymology. Philo describes the substance before God gave it form as ataktos, apoios, apsychos — without order, without quality, without life — a philosophical account of matter as such, written before the Greek Bible's aoratos kai akataskeuastos had any history of interpretation; when Basil reads that Greek clause and refutes the unbegotten matter behind it, the doctrine he is refuting is Philo's and he does not name him. Chalcidius, the one Latin who had read Philo, prints Symmachus's rendering of the pair, otiosum quid confusumque et inordinatum, and glosses tohu as stupor — terra autem stupida quadam erat admiratione — which is Bereshit Rabbah's toheh u-voheh and Rashi's astonishment, given a psychological reading on a Latin page seven hundred years before Rashi. Lyra, who read Rashi and does not take that reading here, gives the pair two physical causes, invisible because covered on every side with water and empty because not yet furnished with plants, and derives the darkness of the verse from the name of the deep: a-byssus, without whiteness, because white is the colour that holds the most light. Asked what the words mean, the rabbinic bench points at a green line encircling the world and the Latin bench takes a Greek loanword apart. Each answers with the language it happens to be reading in.")
