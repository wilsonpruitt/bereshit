...
FINDING = (
 ...
 "daf that makes Genesis 1 do work for the legislation that follows it. His framing does survive "
 "on the Latin bench, with the philosophy taken out: other lawgivers wrote either bare statutes or "
