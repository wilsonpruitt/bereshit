...
add(id="rashi-1-1", work="rashi-gen", author="rashi", tradition="rabbinic",
    ...
    english={"text": hcut(_raw("rashi-gen-1.json", "en", 0)[0], "בראשית IN THE BEGINNING — Rabbi Isaac said",
             ...
             "translator": "M. Rosenbaum and A. M. Silbermann, 1929–34", "license": "silbermann"},
    tradents=["r-yitzchak"],
...
add(id="ambrose-hex-1-5", work="ambrose-hex", author="ambrose", tradition="latin",
    date=387, date_precision="circa", place="milan",
    anchor={"verse": "gen.1.1"}, lemma={"la": "dum opus videtur, praefertur operator", "en": "while the work is seen, the workman is put forward"},
    original=latin("6958", "Est ergo hic mundus divinae specimen operationis",
                   "peritiam ejus ostendunt", 14),
    english={"text": "This world, then, is a specimen of the divine working; because while the work is seen, the workman is put forward. For as of these arts of ours some are active, which consist in the movement of the body or the sound of the voice — the movement or the sound ceased, nothing was left over, nothing remained to those who watched or listened; others are theoretical, which exercise the vigour of the mind; others of such a kind that, the office of working having ceased, the work's own service still appears, as building and weaving, which even when the craftsman is silent show his skill.", **DRAFT},
    cruxes=["why-begin-here"], senses=["literal"],
...
THREADS = [
 ...
 E("t-k2-09", "ambrose-hex-1-5", "ambrose-hex-1-1b", "echoes", "Two answers a few columns apart and they are the two halves of one: Moses could write it because he was a witness of the divine work, and it is worth writing because a work goes on showing its workman after he has fallen silent, as building and weaving do. The first secures the text, the second secures the subject."),
...
FINDING = (
 ...
 "specimen of the divine working, because while the work is seen the workman is put forward, as a "
...
ANSWERS = {
 ...
 "the-work-shows-the-maker": {"label": "The work shows the workman", "gloss": "The world is a specimen of the divine working: like building and weaving, it shows the craftsman's skill even when the craftsman is silent (Ambrose)."},
