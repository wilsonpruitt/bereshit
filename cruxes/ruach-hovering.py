...
add(id="vulgate-1-2", work="vulgate", author="jerome", tradition="latin",
    ...
    english={"text": "But the earth was empty and void, and darkness [was] upon the face of the deep, and the Spirit of God was borne over the waters.", **APPROVED},
    cruxes=["ruach-hovering", "tohu-vabohu"], senses=["translation"],
...
add(id="targ-onk-1-2", work="targ-onk", author="onkelos", tradition="rabbinic",
    ...
    english={"text": "And the earth was waste and empty, and darkness was spread over the face of the deep, and a wind from before the LORD was blowing over the face of the waters.", **APPROVED},
    cruxes=["ruach-hovering", "tohu-vabohu"], senses=["translation"],
...
add(id="targ-psj-1-2", work="targ-psj", author="targum-pseudo-jonathan", tradition="rabbinic",
    ...
    english={"text": psj_en, "translator": "J. W. Etheridge, 1862", "license": "pd"},
    cruxes=["ruach-hovering", "tohu-vabohu"], senses=["translation"],
...
add(id="isidore-quaest-1-3", work="isidore-quaest", author="isidore", tradition="latin",
    ...
    english={"text": "'And the Spirit of God was borne over the waters.' The Spirit of God was already being borne over our dark and fluid heart, as over waters: that standing in him we might find rest, be quickened by his breath, and be washed in his wave.", **APPROVED},
...
add(id="alcuin-int-29", work="alcuin-int", author="alcuin", tradition="latin",
    ...
    english={"text": "Question 29. What is 'The Spirit of the Lord was borne over the waters'? — Answer: Not by wandering over them, but by power and a ruler's command, to form and quicken the formless matter which in this place is signified by the name of water.", **APPROVED},
    cruxes=["ruach-hovering"], senses=["literal"],
...
add(id="rabanus-gen-1-1", work="rabanus-gen", author="rabanus", tradition="latin",
    ...
    english={"text": "'And the Spirit of God was borne over the waters.' It is not to be supposed childishly that the creator Spirit, of whom it is written 'The Spirit of the Lord has filled the whole earth' (Wis 1:7), was borne above the things to be created by position in place. Rather it is to be understood that by divine power he excelled the creatures, holding in his own power when he would illumine the abyss of waters, when he would part them into one place so that the dry land might appear, when and how he would dispose the other creatures at his nod — in the likeness, that is, of a craftsman, whose will is accustomed to be borne above the things that are to be made.", **APPROVED},
    cruxes=["ruach-hovering"], senses=["literal"],
...
add(id="bruno-gen-1-2", work="bruno-gen", author="bruno-of-segni", tradition="latin",
    ...
    english={"text": "But the Spirit of God was borne over the waters, because, like a good craftsman, he was even then arranging to make this so manifold variety of creatures that we see. So we too, for example, when about to build a house, looking over the timber with eye and mind, assign some pieces to beams, some to columns, and others to other uses.", **APPROVED},
    cruxes=["ruach-hovering"], senses=["literal"],
...
add(id="hugh-adnot-gen-1-2", work="hugh-adnot", author="hugh-of-st-victor", tradition="latin",
    ...
    english={"text": "'And the Spirit of God was borne over the waters.' He calls 'the Spirit of God' his intention, who like a craftsman presided over the work to be formed; 'the waters' he calls that mist, on account of its mobility; and so he names the same thing now 'abyss' for its depth, now 'darkness' for the absence of light, now 'waters' for its mobility.", **APPROVED},
...
FINDING = "Rashi's Old French acoveter and Jerome's incubabat are the same word for the same Hebrew, with no contact. Abelard is the one Latin who reports the Hebrew as 'fluttering' (volitabat), on the rabbinic side of the verb. The verb is the whole crux. Merahefet occurs once more in the Bible, of an eagle over its nest at Deut 32:11, and the Seventy flattened it to epephereto, was borne upon — a verb of motion over a surface with no bird in it — and Jerome, who knew better and said so in the Hebrew Questions, left ferebatur standing in the Vulgate anyway. So the Latin bench inherited a verb its own best philologist had already corrected, and spent eight centuries putting the bird back. It came back as two different birds. Basil's unnamed Syrian has the Spirit warm the waters like a hen sitting on eggs, and that hen travels through Ambrose, Augustine, Rupert and Comestor until by Honorius vel aquas fovebat is offered as a bare variant with no Syrian and no bird attached; Jerome's is the same picture claimed from the Hebrew verb itself, incubabat, brooding. On the other bench Ben Zoma's dove hovers over her young and does not touch, and the Bavli turns the not-touching into a measurement, the gap between the upper and the lower waters argued down to a hair's breadth. Same verb, opposite physics: the Latin bird warms by contact and the rabbinic bird is defined by keeping its distance, and Rashi, taking the dove from Chagigah rather than the unspecified bird of Bereshit Rabbah, glosses it in Old French with the Latin bench's own word. The other Latin line has no bird at all. Augustine, against the Manichees, rules that ferebatur is about power and not place, and gives the image that carries the ruling, as the will of a craftsman is borne above the wood; Rabanus makes it a simile, Remigius gives the craftsman wisdom, Bruno makes him a house-builder sorting timber, and by Lyra it has shrunk to a gloss, spiritus Dei, id est voluntas, that no longer needs to say whose image it is. What neither bench does is ask the question Philo asked first: not what the spirit is but why the verse gives it something extra. Of everything in the inventory only the breath is called God's, and Philo's reason is functional, because breath is the most life-giving of things and God is the cause of life. Augustine at Confessions 13 asks the identical question, why only the Holy Spirit is said to be borne above, and answers from the Trinity and from the weight of love. Onkelos had answered it by removing it, a wind from before the Lord; Neofiti by a third route neither bench took, a spirit of mercy."
