...
add(id="angelom-gen-1-1b", work="angelom-gen", author="angelomus", tradition="latin",
    ...
    english={"text": "But it is asked why it is said thus: 'In the beginning God made heaven and earth', and not said: 'In the beginning God said, Let heaven and earth be made', as it is told of the light: 'God said, Let there be light', and the rest? — Unless because first what he made had to be taken in universally under the name of heaven and earth, and commended, and then gone through in its parts, as it is read to have been done.", **APPROVED},
    cruxes=["heaven-earth-order"], senses=["literal"],
...
add(id="remigius-gen-1-1b", work="remigius-gen", author="remigius", tradition="latin",
    ...
    english={"text": "'For he created heaven and earth.' By 'heaven' we ought not to understand this visible firmament, but that empyrean — that is, fiery, or intellectual — heaven, which is called fiery not from burning but from brightness, and which was at once filled with the angelic spirits, of whom it is said in Job: 'When the morning stars praised me together, and all the sons of God shouted for joy' (Job 38:7). And note that three elements are named here. For under the name of heaven gather the air; under the name of earth, the earth itself, and the fire that lies hidden in its bowels. Of the fourth element, that is water, mention is made in what follows.", **APPROVED},
    cruxes=["heaven-earth-order"], senses=["literal"],
...
THREADS = [
 ...
 E("t-k5-x1", "bruno-gen-1-1", "br-1-15", "parallel", "Phase 4. The closest Latin analogue to Beit Shammai and Beit Hillel anywhere on the bench, and it turns on the same psalm. Bruno quotes Ps 102:25 [Vg 101:26], 'you in the beginning founded the earth, and the heavens are the works of your hands', and concludes: 'not, therefore, heaven before earth, but God created heaven and earth together'. R. Yehuda bar Ilai brings the identical verse for Beit Hillel to prove the earth was first, and R. Shimon ben Yoḥai closes the section with the stewpot and its lid. Written at Phase 4 because `bruno-gen-1-1` was built for K1."),
 E("t-k5-x2", "bruno-gen-1-1", "ambrose-hex-1-6-24", "echoes", "Phase 4. Both answer the order question with Sir 18:1, 'he who lives for ever created all things at once', set against a psalm that names the earth first, and both conclude that the sequence of the words gives heaven no privilege. Bruno does not name Ambrose and the argument is the same argument."),
 E("t-k5-x3", "glossa-1-1", "aug-gnl-1-9", "cites", "Phase 4. 'Quia universaliter nomine coeli et terrae comprehendendum erat quidquid fecit Deus, deinde per partes explicandum quomodo fecit' is De Genesi ad litteram I.9 reproduced almost word for word at the head of the standard gloss on Gen 1:1. Written at Phase 4 because the VERS. 1 block was sliced whole for K1 and carries several cruxes' glosses at once."),
 E("t-k5-x4", "glossa-1-1", "remigius-gen-1-1b", "echoes", "Phase 4. The empyrean gloss inside the Glossa's VERS. 1 block — a heaven fiery not from burning but from brightness, filled at once with the angelic spirits — is Remigius at PL 131:54D almost verbatim, and it is how the empyrean reading became the schoolroom default that Abelard and Ibn Ezra each attack from their own side."),
 E("t-k5-x5", "rabanus-gen-1-1b", "ambrose-hex-1-6-20", "transmits", "Phase 4. PL 107:444B copies Ambrose Hexaemeron I.6.20 verbatim and unnamed, from 'In principio itaque temporis, coelum et terram Deus fecit' — time is from this world, not before the world, and a day is a portion of time, not its beginning. The transmission is what puts Ambrose's answer into the Carolingian schools. Written at Phase 4 because `rabanus-gen-1-1b` was built for K1."),
]
...
FINDING = ("Both benches ask which was made first, and both end by refusing the question — and they refuse it with the "
           ...
           "of the heavens, what will you do with the earth? The oldest witnesses on the daf decline the question in a third way. Philo's inventory of what was made first has no heaven overhead in it at all — an incorporeal heaven, an invisible earth, the idea of air and of void — and when the chapter reaches the firmament he explains the second name by a definition of body: stereoma because it is solid, and solid because it is extended in three directions, so that the word itself marks the corporeal heaven off from the intelligible one. Chalcidius carried that reading into Latin in the fourth century and named its author — Philo, who judges heaven and earth to be incorporeal and intelligible essences — which is the only place in this edition where a Latin cites a Jewish author by name and the passage he cites is printed beside him; and then nobody read Chalcidius, so that Remigius arrives at the intelligible heaven six hundred years later with the conclusion and no argument, and Comestor turns it into the container and the thing contained. Lyra ends the Latin side by treating the question as settled physics: the heaven of the first verse is the heavenly bodies distinct in their substantial forms, the earth likewise, and the pair is Abelard's four elements read through a fourteenth-century commentary on the De caelo.")
...
add(id="chalcidius-caelum-et-terra", work="chalcidius-tim", author="chalcidius", tradition="latin",
    date=350, date_precision="range-300-400", place="cordoba",
    anchor={"verse": "gen.1.1"},
    lemma={"la": "negant hoc coelum ab initio factum, sed secundo die", "en": "they deny that this heaven was made in the beginning, but on the second day"},
    original={"lang": "la", "text": "Quod autem coelum quamue terram scriptura loquatur intelligendum. Qui tumultuario contenti sunt intellectu, coelum hoc quod uidemus, et terram qua subuehimur dici putant; porro qui altius indagantur negant hoc coelum ab initio factum, sed secundo die. Namque ab initio factum lumen, idque diem esse cognominatum. Hoc uero coelum postea, quod Deus appellauerit soliditatem. Tertio deinceps die remotis aquis apparuit sicca, eique terrae nomen impositum. Ut sit euidens neque hoc coelum cognitum nobis, neque hanc in qua sumus terram ab exordio facta, sed alia esse antiquiora intellectu potius quam sensibus haurienda. Aliud igitur uerum coelum, et aliud quiddam esse soliditatem scriptura testatur; eodemque modo aliud terram, et item aliud siccam. Quod igitur illud coelum prius quam caetera Deus condidit, quamue terram? Philo carentes corpore atque intelligibiles essentias esse censet, ideas et exemplaria tam siccae istius terrae quam soliditatis. Denique etiam hominem prius intelligibilem, et exemplum archetypum generis humani, tunc demum corporeum factum a Deo esse dicit. Alii non ita, sed sciente prophetam duas esse species rerum omnium, alteram intelligibilem, alteram sensilem, eas uirtutes quae utranque naturam circumplexae contineant, coelum et terram cognominasse. Coelum quidem incorpoream naturam, terram uero quae substantia est corporum, quam graeci ὕλην uocant.",
    ...
    english={"text": "But it is to be understood what heaven, or what earth, Scripture is speaking of. Those who are content with a hasty understanding think that this heaven which we see, and the earth on which we are carried, are meant; whereas those who search more deeply deny that this heaven was made in the beginning, but on the second day. For in the beginning light was made, and that was called day. But this heaven afterwards, which God called the solidity. Then on the third day, the waters being removed, the dry appeared, and the name of earth was imposed on it. So that it is evident that neither this heaven known to us, nor this earth on which we are, was made from the outset, but that there are others more ancient, to be drawn in by the understanding rather than by the senses. Scripture therefore testifies that the true heaven is one thing and the solidity another; and in the same way that the earth is one thing and the dry another. What heaven, then, did God found before the rest, or what earth? Philo judges them to be incorporeal and intelligible essences, the ideas and exemplars both of this dry land and of the solidity. And finally he says that the human too was first intelligible, the archetypal exemplar of the human race, and only then made corporeal by God. Others not so: but that the prophet, knowing that there are two species of all things, one intelligible and one perceptible, called those powers which embrace and contain both natures 'heaven and earth' — heaven being the incorporeal nature, and earth that which is the substance of bodies, which the Greeks call hyle.", **DRAFT},
    tradents=["philo"],
    cruxes=["heaven-earth-order", "ex-nihilo-or-matter"], senses=["literal", "spiritual"],
    answers=["heaven-earth-is-everything", "heaven-is-empyrean"],
    notes="The oldest Latin statement of this crux on the daf, and it arrives with an apparatus nobody after him has. The question is put exactly as the twelfth century will put it — what heaven and what earth does Scripture mean? — and answered by a chronology within the chapter itself: the firmament is called heaven on the second day and the dry is called earth on the third, so the heaven and earth of the first verse cannot be the ones we see, and must be older and intelligible rather than sensible. That is Remigius's empyrean and Comestor's container-and-contained argument, six hundred years early. What is unique to Chalcidius is the sourcing. He names Philo, who does not appear anywhere else in this edition and whom the Latin bench of Gen 1 never cites: heaven and earth are the incorporeal ideas and exemplars, and the human too was intelligible before he was corporeal. Then he reports a second school — alii non ita — for whom the two names are the two species of all things, the intelligible and the perceptible, earth being the substance of bodies, quam graeci hylen uocant. The Greek word is printed in Greek type in the 1520 edition. On the other bench the same question is Beit Shammai against Beit Hillel at b. Chagigah 12a, and the same instinct is R. Akiva's, that the et of the verse must include something more than what is named."
)

# ---------------------------------------------------------------- threads (K5, Chalcidius block)
_E5 = lambda i, f, t, ty, ev: thread("heaven-earth-order", i, f, t, ty, ev)
THREADS.extend([
 _E5("t-k5-c1", "chalcidius-caelum-et-terra", "b-chag-12a-shamayim", "parallel", "Both benches decide that the heaven of the first verse is not the one overhead, and both get there by reading the chapter against itself. Chalcidius: those content with a hasty understanding think this heaven is meant, but the firmament is not called heaven until the second day and the dry is not called earth until the third, so the heaven and earth of the beginning must be older, and drawn in by the understanding rather than by the senses. The Bavli asks what shamayim is and answers by decomposing the word. The move is the same — the name in v. 1 cannot be the thing the chapter later names — and the machinery is entirely different."),
 _E5("t-k5-c2", "chalcidius-caelum-et-terra", "remigius-gen-1-1b", "parallel", "Remigius's empyrean, six hundred years early and argued rather than asserted. Remigius says the heaven of v. 1 is that empyrean, fiery or intellectual heaven, and leaves it there. Chalcidius reaches the same conclusion from the chapter's own sequence and then names two schools for what the intelligible heaven and earth are — Philo's ideas and exemplars, or the two species of all things, incorporeal nature and hyle. There is no line of transmission: Remigius has the doctrine without the argument."),
