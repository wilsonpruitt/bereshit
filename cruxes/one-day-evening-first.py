...
add(id="lxx-1-5", work="lxx", author="lxx-translators", tradition="greek-jewish",
    ...
    english={"text": "And God called the light Day, and the darkness he called Night. And there was evening and there was morning, one day.", **DRAFT},
...
add(id="vulgate-1-5", work="vulgate", author="jerome", tradition="latin",
    ...
    english={"text": "And he called the light Day, and the darkness Night. And there was made evening and morning, one day.", **DRAFT},
    cruxes=["one-day-evening-first"], senses=["translation"],
    answers=["unus-cardinal"],
...
add(id="targ-psj-1-5", work="targ-psj", author="targum-pseudo-jonathan", tradition="rabbinic",
    ...
    english={"text": "And the LORD called the light Day, and made it that the inhabitants of the world might labour in it; and the darkness he called Night, and made it that in it the creatures might have rest. And it was evening, and it was morning, one day.", **DRAFT},
...
add(id="remigius-gen-1-5", work="remigius-gen", author="remigius", tradition="latin",
    ...
    english={"text": "Verse 5. 'There was evening and morning, one day.' By morning is understood the beginning of faith; by evening, the perfection of good work. The morning of this day is drawn out into evening when the beginning of faith is perfected by the completion of good work.", **DRAFT},
    cruxes=["one-day-evening-first"], senses=["allegorical"],
...
add(id="comestor-hs-1-5", work="comestor-hs", author="comestor", tradition="latin",
    ...
    english={"text": "'And there was evening, and after that there was morning.' And so one natural day was completed. For first, with heaven and earth, light was created; and as it set little by little, there was made the evening of the first usual day; and as the same light passed under the earth and came to the rising, there was made morning — that is, the night was ended and the second day began. And so, with the light of the day preceding and the night following being ended, one day came to be.", **DRAFT},
    cruxes=["one-day-evening-first"], senses=["literal"],
    answers=["unus-24-hours", "day-precedes-night"],
...
LICENSES = {
 ...
 "wroot-bonaventure": {"label": "Wilson Pruitt's English of Bonaventure, In II Sent. (bonaventure.wrootpress.com) — Wroot Press; licence for this site to be set by Wilson, as with wroot-glossa. [CHECK before publication]"},
}
